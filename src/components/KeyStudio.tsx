...
const KeyCard = ({
    ...
    return (
        <div className="border border-white/15 bg-neutral-950/60 p-4 font-mono text-xs text-neutral-100">
            ...
            <div className="mt-4 flex flex-wrap gap-4 text-bracket text-[0.65rem]">
                ...
                <button type="button" onClick={() => onDeleteKey(data.id)} className="text-red-400 hover:text-red-300">
                    [ delete ]
                </button>
            </div>
        </div>
